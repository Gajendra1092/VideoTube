...
const GoogleOAuthButton = ({ 
  ...
  useEffect(() => {
    ...
    // Only initialize if we have a valid client ID (not the placeholder)
    if (window.google && buttonRef.current && clientId && clientId !== 'your_google_client_id_here') {
      ...
      // Show styled placeholder when Google OAuth is not configured
